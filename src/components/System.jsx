...
const System = () => {
  return (
    <div className=' xl:px-52 pt-24 text-center px-4 '>
        <h1 className='text-white md:text-[42px] text-[32px] lg:px-44 font-bold leading-none'>We put in the time, money & headache, so you don't have to</h1>
...
<div className='flex gap-2 text-[#FFFFFFCC]'>
<p>View Our SDKs</p>
<img src={Arrow} alt='' className='w-[5%] h-3/4 py-1'/>
            ...
            <div className=' p-7 rounded-lg bg-card'>
                <h1 className='text-base pb-2 font-bold text-white'>Focus on Building a Great Game</h1>
                <p className='text-[15px] pb-1 font-semibold text-[#FFFFFF99]'>
