...
const Tools = () => {
  return (
    <div className='text-center pt-20 px-4 md:px-10 lg:px-44 xl:px-96'>
        <h1 className='text-white font-bold text-[32px] 2xl:px-36 md:text-[40px] md:px-20 leading-none'>
        ...
        <img src={Toolsimage} alt='' className='flex justify-center items-center mx-auto xl:w-[100%] pb-3'/>
        </div>
  )
}
